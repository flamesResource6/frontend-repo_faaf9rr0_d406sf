  ...
  return (
    <section id="contatti" className="bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 md:py-20 grid gap-12 md:grid-cols-2">
        <div>
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-900">{t('sections.contact')}</h2>
          ...
          <div className="mt-8 rounded-sm border bg-white p-6">
            <p className="text-sm text-slate-600">{t('sections.email')}</p>
            ...
            <p className="mt-4 text-sm text-slate-600">{t('sections.phone')}</p>
        ...
        <form onSubmit={onSubmit} className="rounded-sm border bg-white p-6">
          <div className="grid gap-5">
            <div>
              <label className="block text-sm font-medium text-slate-700">{t('sections.name')}</label>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700">{t('sections.message')}</label>
            ...
            <button className="inline-flex justify-center rounded-sm bg-slate-900 px-5 py-2.5 text-white font-medium hover:bg-black">{t('sections.send')}</button>
            {sent && <p className="text-sm text-green-700">{t('sections.thanks')}</p>}
          </div>
        </form>
      </div>
